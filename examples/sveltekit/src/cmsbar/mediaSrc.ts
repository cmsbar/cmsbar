...
// MediaBrowser, ported 1:1 from the React originals
// (template/components/cmsbar/EditableImage.tsx + EditableMedia.tsx). Kept in
// one module so the three Svelte components never drift apart.
//
