...
// resolves to THIS file (src/cms.config.ts) - in Vite (vite-tsconfig-paths)
// for the client bundle and in tsx (tsconfig-paths/register) for the server.
...
export const cmsConfig = defineCmsConfig({
  ...
  siteName: "CMSBar Vite SPA example",
  domain: "example.com",
