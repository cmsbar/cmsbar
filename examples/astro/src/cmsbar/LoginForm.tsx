// CMSBar login form (React island). Plain client-side fetch to the CMS login
// endpoint, then a full-page navigation to "/" so the server re-reads the
// freshly set session cookie and the home page hydrates the editor island.
// Mirrors the template's app/cmsbar/login/page.tsx and the other examples'
// login pages. Mounted from src/pages/cmsbar/login.astro with client:load.
...
export function LoginForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Full-page navigation so the server-rendered home re-reads the new cookie.
